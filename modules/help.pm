...
#--- Cluster ----------------------
    ...
    if (($section eq "all") || ($section eq "cluster"))
       ...
       print "                                    no thresholds can be given.\n";
       print "or with\n";
       print "-s, --subselect=listhost            List Clustermembers\n";
       print "-w, --warning=<threshold>           Warning threshold.\n";
       print "-c, --critical=<threshold>          Critical threshold.\n";
       print "                                    Thresholds should be either a simple counter or a percentage\n";
       print "                                    value in the n% (i.e. 90%).\n";
       print "                                    with --hostdown hosts in non OK state are used for checking \n";
       print "    --hostdown                      This could be used in conjunction with thresholds as mentioned above.\n";
       print "or with\n";
       print "-s, --subselect=listvms             list of vmware machines in cluster and their statuses\n";
       print "or with\n";
       print "-s, --subselect=status              overall cluster status (gray/green/red/yellow)\n";
       print "                                    States can be (from the docs):\n";
       print "                                    - gray    The status is unknown.\n";
       print "                                    - green   The entity is OK.\n";
       print "                                    - red     The entity definitely has a problem.\n";
       print "                                    - yellow  The entity might have a problem.\n";
       print "or with\n";
       print "-s, --subselect=issues              all issues for the cluster\n";
       print "-B, --exclude=<black_list>          Blacklist issues.\n";
       print "\n";
       print "Memory:\n";
       print "-------\n";
